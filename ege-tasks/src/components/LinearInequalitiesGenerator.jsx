...
export default function LinearInequalitiesGenerator() {
  const {
    title, setTitle,
  ...
  return (
    <>
      <TrigGeneratorLayout
        ...
        left={
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 10 }}>
            ...
            {CATEGORY_GROUPS_INEQ.map(group => (
              <TrigSettingsSection
                key={group.label}
                label={
                  <TrigBlockToggle
      ...
      <TrigMCSection
        ...
        tasksData={tasksData}
        generatorType="linear_inequalities"
