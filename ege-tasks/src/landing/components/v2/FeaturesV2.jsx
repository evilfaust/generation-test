...
const ANALYTICS_ITEMS = [
  { icon: '📋', title: 'Журнал и оценки', desc: 'Ученик × выдача + журнал «Решу ЕГЭ»' },
  { icon: '✅', title: 'Посещаемость', desc: 'Отметки на уроке и лента по ученику' },
  { icon: '🗓', title: 'Календарь и КТП', desc: 'Расписание пар, планы, заметки уроков' },
  { icon: '📚', title: 'Библиотека материалов', desc: 'Учебники и файлы с папками' },
]
      ...
      <div className="v2-bento v2-reveal" style={{ marginTop: 16 }}>
        ...
        <div className="v2-bento-card v2-bento-card--analytics">
          ...
          <p className="v2-bento-desc">
            {'Классы и группы, журнал оценок и посещаемость, КТП с экспортом в Word, календарь с расписанием пар, заметки уроков и библиотека материалов — вся рутина в одном рабочем месте.'}
          </p>
